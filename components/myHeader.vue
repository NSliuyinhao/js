    ...
    <div>
        <nav class="navbar navbar-default nav-fixed-top">
            <div class="width-limit">
                ...
                <!--登录和注册按钮-->
                <nuxt-link to="/sign-up" class="sign-up btn">注册</nuxt-link>
                <nuxt-link to="/sign-in" class="sign-in btn">登录</nuxt-link>
                <!--如果用户登录那么显示用户头像-->
...
<style scoped>
    ...
    nav .nav-list .drop-menu ul li a{
        padding:  10px 20px;
        display: block;
    }
    nav .nav-list .drop-menu ul li a:hover{
        background-color: #f5f5f5;
    }
    nav .nav-list .drop-menu ul li i{
        margin-right: 15px;
        color: #ea6f5a;
        font-size: 18px;
    }
